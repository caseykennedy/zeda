...
const JobDialog = ({
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="max-h-[100vh] max-w-[780px] overflow-hidden overflow-y-auto rounded border border-black border-silver-900 bg-black text-white md:max-h-[90vh]">
        <DialogHeader>
