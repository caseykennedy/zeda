...
const FeatureGridItem = ({ icon, title, desc }: FeatureShape) => {
  return (
    <div className="group col-span-4 border-l border-silver-800 pl-5 sm:col-span-2 lg:col-span-1">
      <div className="mb-8 mt-4 translate-y-0 transition-all group-hover:-translate-y-4 group-hover:text-violet-500 md:mb-16 [&>svg]:h-8 [&>svg]:w-8">
        {icon}
      </div>
